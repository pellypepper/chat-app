...
const Content = ({}) => {
    const { isAuthenticated, googleLogin } = (0, loginStore_1.useAuthStore)();
    ...
    return (<section id="home" className="relative min-h-screen flex items-center justify-center text-center px-[5%] bg-[radial-gradient(ellipse_at_center,_rgba(88,166,255,0.1)_0%,_transparent_50%)] overflow-hidden">
  {/* Grid Overlay */}
  ...
  <div className="relative z-10 max-w-[800px] animate-fadeInUp">
    ...
    <div className="flex justify-center gap-4 flex-wrap">
      ...
      <a onClick={handleGoogleLogin} className=" px-8 py-4   flex items-center gap-2 border font-medium text-sm rounded-xl">{(0, fc_1.FcGoogle)({ style: { fontSize: 24 } })}Contine with Google</a>
    </div>
  </div>
    </section>);
};
