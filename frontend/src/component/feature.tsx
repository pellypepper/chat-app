...
const Feature = () => {
  return (
<section id="features" className="bg-gradient-feature py-[8rem] px-[5%]">
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-16">
        {[
          ...
          <div key={index} className="feature-card animate text-center border border-primary rounded-lg p-4 flex flex-col space-y-2 bg-card-bg text-text-primary hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:border-[#58a6ff] transition duration-300 ">
