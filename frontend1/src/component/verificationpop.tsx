...
const SuccessPopup: React.FC<SuccessPopupProps> = ({ message, handleTimeout }) => {
  return (
<div id="success-popup" className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50`}>
  <div className="bg-gray-800 text-primary rounded-2xl p-8 max-w-md w-full relative shadow-lg">
    <button onClick={handleTimeout} className="absolute top-3 right-4 text-2xl text-white hover:text-red-400" >&times;</button>
    ...
    {/* Optional: SVG checkmark animation */}
