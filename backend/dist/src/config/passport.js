    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                if (!user[0]) {
                    return [2 /*return*/, done(null, false, { message: 'Email not found.' })];
                }
            ...
            case 2:
                ...
                if (!user[0].verified) {
                    return [2 /*return*/, done(null, false, { message: 'Email not verified.' })];
                }
                return [2 /*return*/, done(null, user[0])];
            case 3:
                error_1 = _a.sent();
...
passport_1.default.use(new passport_google_oauth20_1.Strategy({
    ...
    var email, user, newUser, error_2;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                if (!email) {
                    return [2 /*return*/, done(null, false, { message: 'No email found from Google.' })];
                }
                return [4 /*yield*/, db_1.db.select().from(schema_1.users).where((0, drizzle_orm_1.eq)(schema_1.users.email, email))];
            case 1:
                user = _e.sent();
            ...
            case 2:
                ...
                user = newUser;
                _e.label = 3;
            case 3: return [2 /*return*/, done(null, user[0])];
            case 4:
                error_2 = _e.sent();
