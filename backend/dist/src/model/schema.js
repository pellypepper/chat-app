...
var messageTypeEnum = (0, pg_core_1.pgEnum)("message_type", ["text", "image"]);
exports.messages = (0, pg_core_1.pgTable)("messages", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    chatId: (0, pg_core_1.integer)("chat_id").notNull().references(function () { return exports.chats.id; }),
    senderId: (0, pg_core_1.integer)("sender_id").notNull().references(function () { return exports.users.id; }),
...
exports.userChats = (0, pg_core_1.pgTable)("user_chat", {
    chatId: (0, pg_core_1.integer)("chat_id").references(function () { return exports.chats.id; }).notNull(),
    userId: (0, pg_core_1.integer)("user_id").references(function () { return exports.users.id; }).notNull()
...
exports.friends = (0, pg_core_1.pgTable)('friends', {
    ...
    friendId: (0, pg_core_1.integer)('friend_id').notNull().references(function () { return exports.users.id; }),
...
exports.messageDeletes = (0, pg_core_1.pgTable)("message_deletes", {
    messageId: (0, pg_core_1.integer)("message_id").notNull().references(function () { return exports.messages.id; }),
    userId: (0, pg_core_1.integer)("user_id").notNull().references(function () { return exports.users.id; }),
}, function (table) { return ({
    pk: (0, pg_core_1.primaryKey)({ columns: [table.messageId, table.userId] }),
}); });
var storyTypeEnum = (0, pg_core_1.pgEnum)("story_type_enum", ["text", "image"]);
...
exports.storyViews = (0, pg_core_1.pgTable)("story_views", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    storyId: (0, pg_core_1.integer)("story_id").notNull().references(function () { return exports.stories.id; }),
    viewerId: (0, pg_core_1.integer)("viewer_id").notNull().references(function () { return exports.users.id; }),
